...
class QRCodeGenerator {
    ...
    async generate() {
        try {
            ...
            const filename = `The Chopsticks People (Pasir Ris West Wellness Centre).jpg`;
...
const qrCodeGenerator = new QRCodeGenerator(`https://ecss.org.sg/product/the-chopsticks-people-prw/`);
